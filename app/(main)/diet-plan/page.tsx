...
export default function DietPlanPage() {
  ...
  const handleGeneratePlan = async (input: any) => {
    ...
    try {
      ...
      setPlanData(data);
      setShowPlan(true)
      localStorage.setItem("lastDietPlan", JSON.stringify({ input, plan: data }))
    } catch (error) {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {loading ? (
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <h1 className="text-4xl font-bold mb-2 text-balance">Generate Your Diet Plan</h1>
            <p className="text-muted-foreground mb-8">
              Tell us about yourself and we'll create a personalized nutrition plan for your goals.
            </p>
